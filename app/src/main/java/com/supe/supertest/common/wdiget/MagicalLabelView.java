 ...
 * @Description
 */
public class MagicalLabelView extends ViewGroup implements View.OnClickListener{
    ...
    public MagicalLabelView(Context context) {
        super(context);
        mContext = context;
    }

    public MagicalLabelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        getAttrs(context, attrs);
    }

    public MagicalLabelView(Context context, AttributeSet attrs, int defStyleAttr) {
