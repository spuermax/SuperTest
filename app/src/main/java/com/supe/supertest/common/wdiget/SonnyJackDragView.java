...
public class SonnyJackDragView implements View.OnTouchListener {
    ...
    private void initDragView() {
        ...
        mStatusBarHeight = frame.top + 200;
        L.i("MoveView" , "mStatusBarHeight == " + mStatusBarHeight);
        ...
        FrameLayout.LayoutParams layoutParams = createLayoutParams(left, mStatusBarHeight + mBuilder.defaultTop, 0, 200);
//        FrameLayout rootLayout = (FrameLayout) getActivity().getWindow().getDecorView();// 作为添加布局的View
        FrameLayout rootLayout = (FrameLayout) mBuilder.rootView;// 作为添加布局的View
