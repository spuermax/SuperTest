...
public abstract class PageLoader {
    ...
    private void initPaint() {
        ...
        mBatteryPaint.setAntiAlias(true);//抗锯齿
        mBatteryPaint.setDither(true);//设置防抖动
        if (isNightMode) {// 是否是页面模式
            mBatteryPaint.setColor(Color.WHITE);//设置颜色
        } else {
    ...
    public void setBgColor(int theme) {
        if (isNightMode && theme == ReadSettingManager.NIGHT_MODE) {
            mTextColor = ContextCompat.getColor(QsHelper.getInstance().getApplication(), R.color.color_fff_99);
            mPageBg = ContextCompat.getColor(QsHelper.getInstance().getApplication(), R.color.black);
        } else if (isNightMode) {
            mBgTheme = theme;
            ...
            switch (theme) {
                case ReadSettingManager.READ_BG_DEFAULT:
                    mTextColor = ContextCompat.getColor(QsHelper.getInstance().getApplication(), R.color.color_2c);
                    mPageBg = ContextCompat.getColor(QsHelper.getInstance().getApplication(), R.color.color_cec29c);
                    break;
                case ReadSettingManager.READ_BG_1:
                    mTextColor = ContextCompat.getColor(QsHelper.getInstance().getApplication(), R.color.color_2f332d);
                    mPageBg = ContextCompat.getColor(QsHelper.getInstance().getApplication(), R.color.color_ccebcc);
                    break;
                case ReadSettingManager.READ_BG_2:
                    mTextColor = ContextCompat.getColor(QsHelper.getInstance().getApplication(), R.color.color_92918c);
                    mPageBg = ContextCompat.getColor(QsHelper.getInstance().getApplication(), R.color.color_aaa);
                    break;
                case ReadSettingManager.READ_BG_3:
                    mTextColor = ContextCompat.getColor(QsHelper.getInstance().getApplication(), R.color.color_383429);
                    mPageBg = ContextCompat.getColor(QsHelper.getInstance().getApplication(), R.color.color_d1cec5);
                    break;
                case ReadSettingManager.READ_BG_4:
                    mTextColor = ContextCompat.getColor(QsHelper.getInstance().getApplication(), R.color.color_627176);
                    mPageBg = ContextCompat.getColor(QsHelper.getInstance().getApplication(), R.color.color_001c27);
                    break;
            }
        }
...
//            mBookRecord.setChapter(1);//
    ...
    void drawBackground(Bitmap bitmap, boolean isUpdate) {
        ...
        mBatteryPaint.setStyle(Paint.Style.FILL);// 设置填充样式
