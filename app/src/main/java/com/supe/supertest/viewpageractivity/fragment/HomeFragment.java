...
//    }
    ...
    public QsModelPager[] getModelPagers() {
        ...
        modelPager1.icon = R.mipmap.leak_canary_icon;
        modelPager1.iconDefault = R.mipmap.leak_canary_icon;

        QsModelPager modelPager2 = new QsModelPager();
        modelPager2.fragment = new YaDianNaFragment();
        modelPager2.title = "雅典娜";
        modelPager2.icon = R.mipmap.leak_canary_icon;
        modelPager2.iconDefault = R.mipmap.leak_canary_icon;
        ...
        modelPager3.icon = R.mipmap.leak_canary_icon;
        modelPager3.iconDefault = R.mipmap.leak_canary_icon;
        modelPager3.position = 2;

        QsModelPager modelPager4 = new QsModelPager();
        modelPager4.fragment = new AKeFragment();
        modelPager4.title = "阿珂";
        modelPager4.icon = R.mipmap.leak_canary_icon;
        modelPager1.iconDefault = R.mipmap.leak_canary_icon;
